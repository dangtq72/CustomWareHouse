...
{
    public class ExportRefuseController : Controller
    {
        //
        // GET: /ModuleDeclaration/ExportRefuse/
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult SaveEditDeralation(decimal Declaration_Id, decimal Declaration_Refence_Id, string Declaration_Code,
